...
public class ClientCharacteristicConfigurationSettingActivityTest {
    ...
    public static void setUpClass() {
        ...
        mockedStatic.when(() -> MockitoViewModelProvider.getViewModelClass(ClientCharacteristicConfigurationSettingViewModel.class))
    ...
    public void test_propertiesRadioGroup_visibility_00001() {
        ...
        mViewModel.mObserveSetupProcessor.onNext("test_propertiesRadioGroup_visibility_00001");
        mViewModel.mObserveSetupProcessor.onComplete();
    ...
    public void test_propertiesRadioGroup_visibility_00002() {
        ...
        mViewModel.mObserveSetupProcessor.onNext("test_propertiesRadioGroup_visibility_00002");
        mViewModel.mObserveSetupProcessor.onComplete();
