...
public class FakeBloodPressureFeatureViewModel extends BloodPressureFeatureSettingViewModel {
    ...
    public java.util.function.Consumer<Boolean> mUpdateCuffFitDetectionConsumer;
    public java.util.function.Consumer<Boolean> mUpdateIrregularPulseDetectionConsumer;
    public java.util.function.Consumer<Boolean> mUpdatePulseRateRangeDetectionConsumer;
    public java.util.function.Consumer<Boolean> mUpdateMeasurementPositionDetectionConsumer;
    public java.util.function.Consumer<Boolean> mUpdateMultipleBondDetectionConsumer;
                        ...
                        .flatMapCompletable(t -> {
                            switch (t) {
                                ...
                                case "test_isBodyMovementDetectionSupported_visibility_00001":
                                    ...
                                    break;
                                case "test_isBodyMovementDetectionSupported_visibility_00002":
                                    test_isBodyMovementDetectionSupported_visibility_00002();
                                    break;
                                case "test_isBodyMovementDetectionSupported_00001":
                                    test_isBodyMovementDetectionSupported_00001();
                                    break;
                                case "test_isBodyMovementDetectionSupported_00002":
                                    test_isBodyMovementDetectionSupported_00002();
                                    break;
                                case "test_isCuffFitDetectionSupportSupported_visibility_00001":
                                    test_isCuffFitDetectionSupportSupported_visibility_00001();
                                    break;
                                case "test_isCuffFitDetectionSupportSupported_visibility_00002":
                                    test_isCuffFitDetectionSupportSupported_visibility_00002();
                                    break;
                                case "test_isCuffFitDetectionSupportSupported_00001":
                                    test_isCuffFitDetectionSupportSupported_00001();
                                    break;
                                case "test_isCuffFitDetectionSupportSupported_00002":
                                    test_isCuffFitDetectionSupportSupported_00002();
                                    break;
                                case "test_isIrregularPulseDetectionSupported_visibility_00001":
                                    test_isIrregularPulseDetectionSupported_visibility_00001();
                                    break;
                                case "test_isIrregularPulseDetectionSupported_visibility_00002":
                                    test_isIrregularPulseDetectionSupported_visibility_00002();
                                    break;
                                case "test_isIrregularPulseDetectionSupported_00001":
                                    test_isIrregularPulseDetectionSupported_00001();
                                    break;
                                case "test_isIrregularPulseDetectionSupported_00002":
                                    test_isIrregularPulseDetectionSupported_00002();
                                    break;
                                case "test_isPulseRateRangeDetectionSupported_visibility_00001":
                                    test_isPulseRateRangeDetectionSupported_visibility_00001();
                                    break;
                                case "test_isPulseRateRangeDetectionSupported_visibility_00002":
                                    test_isPulseRateRangeDetectionSupported_visibility_00002();
                                    break;
                                case "test_isPulseRateRangeDetectionSupported_00001":
                                    test_isPulseRateRangeDetectionSupported_00001();
                                    break;
                                case "test_isPulseRateRangeDetectionSupported_00002":
                                    test_isPulseRateRangeDetectionSupported_00002();
                                    break;
                                case "test_isMeasurementPositionDetectionSupported_visibility_00001":
                                    test_isMeasurementPositionDetectionSupported_visibility_00001();
                                    break;
                                case "test_isMeasurementPositionDetectionSupported_visibility_00002":
                                    test_isMeasurementPositionDetectionSupported_visibility_00002();
                                    break;
                                case "test_isMeasurementPositionDetectionSupported_00001":
                                    test_isMeasurementPositionDetectionSupported_00001();
                                    break;
                                case "test_isMeasurementPositionDetectionSupported_00002":
                                    test_isMeasurementPositionDetectionSupported_00002();
                                    break;
                                case "test_isMultipleBondSupported_visibility_00001":
                                    test_isMultipleBondSupported_visibility_00001();
                                    break;
                                case "test_isMultipleBondSupported_visibility_00002":
                                    test_isMultipleBondSupported_visibility_00002();
                                    break;
                                case "test_isMultipleBondSupported_00001":
                                    test_isMultipleBondSupported_00001();
                                    break;
    ...
    public void updateBodyMovementDetection(boolean checked) {
        if (mUpdateBodyMovementDetectionConsumer != null) {
            mUpdateBodyMovementDetectionConsumer.accept(checked);
        }
        super.updateBodyMovementDetection(checked);
    }

    @Override
    public void updateCuffFitDetection(boolean checked) {
        if (mUpdateCuffFitDetectionConsumer != null) {
            mUpdateCuffFitDetectionConsumer.accept(checked);
        }
        super.updateCuffFitDetection(checked);
    }

    @Override
    public void updateIrregularPulseDetection(boolean checked) {
        if (mUpdateIrregularPulseDetectionConsumer != null) {
            mUpdateIrregularPulseDetectionConsumer.accept(checked);
        }
        super.updateIrregularPulseDetection(checked);
    }

    @Override
    public void updatePulseRateRangeDetection(boolean checked) {
        if (mUpdatePulseRateRangeDetectionConsumer != null) {
            mUpdatePulseRateRangeDetectionConsumer.accept(checked);
        }
        super.updatePulseRateRangeDetection(checked);
    }

    @Override
    public void updateMeasurementPositionDetection(boolean checked) {
        if (mUpdateMeasurementPositionDetectionConsumer != null) {
            mUpdateMeasurementPositionDetectionConsumer.accept(checked);
        }
        super.updateMeasurementPositionDetection(checked);
    }
    ...
    private void test_isBodyMovementDetectionSupported_visibility_00002() {
        mSavedStateHandle.set("KEY_IS_ERROR_RESPONSE", true);
    }

    private void test_isBodyMovementDetectionSupported_00001() {
        mSavedStateHandle.set("KEY_BODY_MOVEMENT_DETECTION", false);
    }

    private void test_isBodyMovementDetectionSupported_00002() {
        mSavedStateHandle.set("KEY_BODY_MOVEMENT_DETECTION", true);
    }

    private void test_isCuffFitDetectionSupportSupported_visibility_00001() {
        mSavedStateHandle.set("KEY_IS_ERROR_RESPONSE", false);
    }

    private void test_isCuffFitDetectionSupportSupported_visibility_00002() {
        mSavedStateHandle.set("KEY_IS_ERROR_RESPONSE", true);
    }

    private void test_isCuffFitDetectionSupportSupported_00001() {
        mSavedStateHandle.set("KEY_CUFF_FIT_DETECTION", false);
    }

    private void test_isCuffFitDetectionSupportSupported_00002() {
        mSavedStateHandle.set("KEY_CUFF_FIT_DETECTION", true);
    }

    private void test_isIrregularPulseDetectionSupported_visibility_00001() {
        mSavedStateHandle.set("KEY_IS_ERROR_RESPONSE", false);
    }

    private void test_isIrregularPulseDetectionSupported_visibility_00002() {
        mSavedStateHandle.set("KEY_IS_ERROR_RESPONSE", true);
    }

    private void test_isIrregularPulseDetectionSupported_00001() {
        mSavedStateHandle.set("KEY_IRREGULAR_PULSE_DETECTION", false);
    }

    private void test_isIrregularPulseDetectionSupported_00002() {
        mSavedStateHandle.set("KEY_IRREGULAR_PULSE_DETECTION", true);
    }

    private void test_isPulseRateRangeDetectionSupported_visibility_00001() {
        mSavedStateHandle.set("KEY_IS_ERROR_RESPONSE", false);
    }

    private void test_isPulseRateRangeDetectionSupported_visibility_00002() {
        mSavedStateHandle.set("KEY_IS_ERROR_RESPONSE", true);
    }

    private void test_isPulseRateRangeDetectionSupported_00001() {
        mSavedStateHandle.set("KEY_PULSE_RATE_RANGE_DETECTION", false);
    }

    private void test_isPulseRateRangeDetectionSupported_00002() {
        mSavedStateHandle.set("KEY_PULSE_RATE_RANGE_DETECTION", true);
    }

    private void test_isMeasurementPositionDetectionSupported_visibility_00001() {
        mSavedStateHandle.set("KEY_IS_ERROR_RESPONSE", false);
    }

    private void test_isMeasurementPositionDetectionSupported_visibility_00002() {
        mSavedStateHandle.set("KEY_IS_ERROR_RESPONSE", true);
    }

    private void test_isMeasurementPositionDetectionSupported_00001() {
        mSavedStateHandle.set("KEY_MEASUREMENT_POSITION_DETECTION", false);
    }

    private void test_isMeasurementPositionDetectionSupported_00002() {
        mSavedStateHandle.set("KEY_MEASUREMENT_POSITION_DETECTION", true);
    }

    private void test_isMultipleBondSupported_visibility_00001() {
        mSavedStateHandle.set("KEY_IS_ERROR_RESPONSE", false);
    }

    private void test_isMultipleBondSupported_visibility_00002() {
        mSavedStateHandle.set("KEY_IS_ERROR_RESPONSE", true);
    }
