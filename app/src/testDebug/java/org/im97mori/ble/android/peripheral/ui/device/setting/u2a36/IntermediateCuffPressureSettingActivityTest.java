...
public class IntermediateCuffPressureSettingActivityTest {
    ...
    public static void setUpClass() {
        ...
        mockedStatic.when(() -> AutoDisposeViewModelProvider.getViewModelClass(IntermediateCuffPressureSettingViewModel.class))
                .thenReturn(FakeIntermediateCuffPressureSettingViewModel.class);
    }
    ...
    public void test_menu_save_00003() {
        ...
        intermediateCuffPressureCharacteristicData.property = BluetoothGattCharacteristic.PROPERTY_INDICATE;
        ...
        assertEquals(json, resultData.getStringExtra(INTERMEDIATE_CUFF_PRESSURE_CHARACTERISTIC.toString()));
    }
