...
@HiltViewModel
public class FakeModelNumberStringSettingViewModel extends ModelNumberStringSettingViewModel {
    ...
    @Inject
    FakeModelNumberStringSettingViewModel(@NonNull SavedStateHandle savedStateHandle
