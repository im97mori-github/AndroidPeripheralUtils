...
public class IntermediateCuffPressureSettingActivity extends BaseActivity {
    ...
    private TextInputLayout mCurrentCuffPressure;
    private TextInputEditText mCurrentCuffPressureEdit;
    ...
    private TextInputLayout mNotificationCount;
    private TextInputEditText mNotificationCountEdit;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mCurrentCuffPressure = findViewById(R.id.currentCuffPressure);
        mCurrentCuffPressureEdit = (TextInputEditText) mCurrentCuffPressure.getEditText();
        ...
        mNotificationCount = findViewById(R.id.notificationCount);
        mNotificationCountEdit = (TextInputEditText) mNotificationCount.getEditText();
        ...
        mViewModel.observeUnit(this, charSequence -> mCurrentCuffPressure.setSuffixText(charSequence));

        mViewModel.observeCurrentCuffPressure(this, charSequence -> distinctSetText(mCurrentCuffPressureEdit, charSequence));
        mViewModel.observeCurrentCuffPressureError(this, charSequence -> mCurrentCuffPressure.setError(charSequence));
        mCurrentCuffPressureEdit.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable s) {
                mViewModel.updateCurrentCuffPressure(s);
            }
        });
        ...
        Button clientCharacteristicConfigurationSettingButton = findViewById(R.id.clientCharacteristicConfigurationSettingButton);
        clientCharacteristicConfigurationSettingButton.setOnClickListener(v ->
        ...
        mViewModel.observeNotificationCount(this, charSequence -> distinctSetText(mNotificationCountEdit, charSequence));
        mViewModel.observeNotificationCountError(this, charSequence -> mNotificationCount.setError(charSequence));
        mNotificationCountEdit.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            ...
            @Override
            public void afterTextChanged(Editable s) {
                mViewModel.updateNotificationCount(s);
            }
        });
