...
public class ManufacturerNameStringSettingActivity extends BaseActivity {
    ...
    private TextInputLayout mManufacturerNameString;
    private TextInputEditText mManufacturerNameStringEdit;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manufacturer_name_string_setting_activity);
        ...
        mManufacturerNameStringEdit = (TextInputEditText) mManufacturerNameString.getEditText();
        ...
        mViewModel.observeManufacturerNameString(this, charSequence -> distinctSetText(mManufacturerNameStringEdit, charSequence));
        mViewModel.observeManufacturerNameStringError(this, charSequence -> mManufacturerNameString.setError(charSequence));
        mManufacturerNameStringEdit.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
